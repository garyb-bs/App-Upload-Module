...
public class EspressoTest {
    ...
    private static String jsonFilePath = "src/test/resources/app/espresso.json";

    // Provide unique custom IDs (if IDs exist, it will use the
    private static String appCustomID = "MyCalculatorApp2";
    private static String testSuiteCustomID = "MyCalculatorAppTests2";
    ...
    private static String testSuiteURL = "https://www.browserstack.com/app-automate/sample-apps/android/CalculatorTest.apk";

    // Set the path to the files on your machine
    private static File appFile = new File("/Users/garybehan/Downloads/Calculator.apk");
    private static File testSuiteFile = new File("/Users/garybehan/Downloads/CalculatorTest.apk");
